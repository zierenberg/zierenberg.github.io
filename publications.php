...
<body>
	...
	<div class="container">
		<div class="row flex-xl-nowrap">
          ...
          See also <a href="https://scholar.google.de/citations?user=qbTyWP4AAAAJ&hl=de&oi=ao">google scholar</a>, 
                   <a href="https://arxiv.org/a/zierenberg_j_1.html">arxiv</a>, 
          or       <a href="https://orcid.org/0000-0001-5840-3791">ORCID</a>.
          <br>
          <br>
          </div>
	...
	<!-- Icons -->
	<script>
		document.getElementById('navbar_pubs').classList.add("active");
	</script>
